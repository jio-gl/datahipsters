...
#        '''
#        # Test ALL 6 widgets!!!
#        # Widget with JQuery -> http://alexmarandon.com/articles/web_widget_jquery/
#        'https://datahipsters.appspot.com/admin_client?client_id=Jose&recos_left=10000&actions_left=500&action_token=qwerty777&reco_token=qwerty666&admin_secret=DgrvFDGYT75FGYGHfFTfRf874fjhrfgtfgg64467gfthu6ggfvdrv367HdFgFvFrFFT5248HdW64747373fhfh37fh4S&widget_recommended_items={%%20for%20result%20in%20results%20%}%3Cdiv%3E%3Ca%20href=%22http://yoururl.com/item/{{result.item_id}}%22%3E{{result.item_id}}%3C/a%3E%3C/div%3E{%%20endfor%20%}%3C/p%3E'
#        'https://datahipsters.appspot.com/admin_client?client_id=Jose&recos_left=10000&actions_left=500&action_token=qwerty777&reco_token=qwerty666&admin_secret=DgrvFDGYT75FGYGHfFTfRf874fjhrfgtfgg64467gfthu6ggfvdrv367HdFgFvFrFFT5248HdW64747373fhfh37fh4S&widget_similar_items={%%20for%20result%20in%20results%20%}%3Cdiv%3E%3Ca%20href=%22http://yoururl.com/item/{{result.item_id}}%22%3E{{result.item_id}}%3C/a%3E%3C/div%3E{%%20endfor%20%}%3C/p%3E'
#        'https://datahipsters.appspot.com/admin_client?client_id=Jose&recos_left=10000&actions_left=500&action_token=qwerty777&reco_token=qwerty666&admin_secret=DgrvFDGYT75FGYGHfFTfRf874fjhrfgtfgg64467gfthu6ggfvdrv367HdFgFvFrFFT5248HdW64747373fhfh37fh4S&widget_top_items={%%20for%20result%20in%20results%20%}%3Cdiv%3E%3Ca%20href=%22http://yoururl.com/item/{{result.item_id}}%22%3E{{result.item_id}}%3C/a%3E%3C/div%3E{%%20endfor%20%}%3C/p%3E'
#        'https://datahipsters.appspot.com/admin_client?client_id=Jose&recos_left=10000&actions_left=500&action_token=qwerty777&reco_token=qwerty666&admin_secret=DgrvFDGYT75FGYGHfFTfRf874fjhrfgtfgg64467gfthu6ggfvdrv367HdFgFvFrFFT5248HdW64747373fhfh37fh4S&widget_recommend_item_to={%%20for%20result%20in%20results%20%}%3Cdiv%3E%3Ca%20href=%22http://yoururl.com/item/{{result.user_id}}%22%3E{{result.user_id}}%3C/a%3E%3C/div%3E{%%20endfor%20%}%3C/p%3E'
#        'https://datahipsters.appspot.com/admin_client?client_id=Jose&recos_left=10000&actions_left=500&action_token=qwerty777&reco_token=qwerty666&admin_secret=DgrvFDGYT75FGYGHfFTfRf874fjhrfgtfgg64467gfthu6ggfvdrv367HdFgFvFrFFT5248HdW64747373fhfh37fh4S&widget_similar_users={%%20for%20result%20in%20results%20%}%3Cdiv%3E%3Ca%20href=%22http://yoururl.com/item/{{result.user_id}}%22%3E{{result.user_id}}%3C/a%3E%3C/div%3E{%%20endfor%20%}%3C/p%3E'
#        'https://datahipsters.appspot.com/admin_client?client_id=Jose&recos_left=10000&actions_left=500&action_token=qwerty777&reco_token=qwerty666&admin_secret=DgrvFDGYT75FGYGHfFTfRf874fjhrfgtfgg64467gfthu6ggfvdrv367HdFgFvFrFFT5248HdW64747373fhfh37fh4S&widget_top_users={%%20for%20result%20in%20results%20%}%3Cdiv%3E%3Ca%20href=%22http://yoururl.com/item/{{result.user_id}}%22%3E{{result.user_id}}%3C/a%3E%3C/div%3E{%%20endfor%20%}%3C/p%3E'
